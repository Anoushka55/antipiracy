...
export function Card({ children, className = '', hover = false, onClick, padding = 'p-6' }: {
  ...
  const shadow = hover
    ? 'hover:shadow-[0_10px_25px_-5px_rgba(200,51,40,0.12),0_4px_10px_-5px_rgba(200,51,40,0.08)] hover:-translate-y-0.5 cursor-pointer'
...
export function DarkCard({ children, className = '', padding = 'p-6' }: {
  ...
  return (
    <div className={`bg-[#111111] rounded-2xl border border-white/10 ${padding} ${className}`}>
      {children}
    </div>
  );
}

export function MetricCard({ label, value, unit, icon: Icon, color = '#c83328', trend }: {
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#E2E8F0] p-5 shadow-[0_1px_3px_0_rgba(0,0,0,0.08)] hover:shadow-[0_4px_12px_rgba(200,51,40,0.1)] transition-all duration-200">
      ...
      <div className="font-mono font-bold text-2xl text-[#111111]" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
        {value}
...
export function KPICard({ title, value, unit, statusColor = '#c83328' }: {
  ...
  return (
    ...
    >
      ...
      <div className="text-2xl font-semibold font-mono text-[#111111]" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
        {value}
      </div>
